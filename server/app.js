...
app.get('/index', (req, res) => res.sendFile('index.html', {root: __dirname+'/../public'}));
app.get('/index.html', (req, res) => res.sendFile('index.html', {root: __dirname+'/../public'}));

app.use((req, res) => middlewares.notFound(req, res));